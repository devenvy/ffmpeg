# FFmpeg 9.0.2 · GPLv2 — build coverage

_Auto-generated by `scripts/gen-matrix.sh` from FFmpeg n9.0.2's `configure` and the build scripts — do not edit by hand. Back to the [matrix index](README.md)._
